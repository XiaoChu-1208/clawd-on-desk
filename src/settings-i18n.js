...
(function initSettingsI18n(root) {
  const STRINGS = {
    ...
    zh: {
      ...
      shortcutsTitle: "快捷键",
      shortcutsSubtitle: "为 Claude Baby 显隐和权限操作设置全局快捷键。留空即可解绑。",
      ...
      shortcutLabelTogglePet: "显示/隐藏 Claude Baby",
      ...
      agentsSubtitle: "按 agent 类型开关追踪。关闭后会停掉日志监视器、在 HTTP 入口丢弃 hook 事件——不会再驱动 Claude Baby 、不弹权限气泡、不记会话。",
      ...
      agentInstallHintDesc: "检测到本机可能有 {agents}。安装由 Clawd 管理的 hooks、插件或扩展后，它们就能驱动 Claude Baby 。",
      ...
      rowSessionHudDesc: "在 Claude Baby 下方显示活跃会话状态。",
      ...
      shortcutLabelPetReveal: "单击 Claude Baby：显示会话 HUD",
      shortcutLabelOpenDashboard: "Ctrl / ⌘ + 单击 Claude Baby：打开会话面板",
      ...
      rowBubbleFollowDesc: "把权限气泡和更新气泡放在 Claude Baby 旁边，而不是屏幕角落。",
      ...
      rowAllowEdgePinningDesc: "开启后 Claude Baby 贴屏幕边缘时，顶/底装饰（花花、建筑、气泡等）可能被裁掉。",
      rowDisableMiniMode: "关闭极简模式",
      rowDisableMiniModeDesc: "开启后 Claude Baby 不会进入极简模式，也不会播放边缘吸附的迷你动画。",
      rowKeepSizeAcrossDisplays: "跨显示器保持大小",
      rowKeepSizeAcrossDisplaysDesc: "移动到另一台显示器时不自动重新缩放。滑块仍按当前显示器的比例调整 Claude Baby 。",
      rowSize: "大小",
      rowSizeDesc: "拖动调整 Claude Baby 大小。",
      rowTextScale: "文字大小",
      rowTextScaleDesc: "缩放本屏幕上气泡、会话 HUD、Dashboard 和设置页的文字。每块屏幕分别记忆；不影响 Claude Baby 本体。",
      ...
      animOverridesWideHitboxDesc: "给这一帧启用更宽的点击区。素材视觉延伸超出默认 Claude Baby 轮廓时有用。",
